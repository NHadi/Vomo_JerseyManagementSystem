...
window.AuditPage = class {
    ...
    async updateFilterOptions() {
        try {
            ...
            const data = await vomoAPI.getAuditsByDateRange(formattedStartDate, formattedEndDate);
    ...
    async loadData() {
        try {
            ...
            let data = await vomoAPI.getAuditsByDateRange(formattedStartDate, formattedEndDate);
